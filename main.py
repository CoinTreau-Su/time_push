...
#推送信息
def send_message(to_user, access_token, city_name, weather, max_temperature, min_temperature,  alarm, lifetips, qinghua):
...
if __name__ == "__main__":
    ...
    # 公众号推送消息
    for user in users:
        send_message(user, accessToken, city, weather, max_temperature, min_temperature,  alarm, lifetips, qinghua)
    import time
    time_duration = 3.5
